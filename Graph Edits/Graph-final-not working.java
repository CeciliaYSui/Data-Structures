...
public class Graph{
    ...
    public static void main (String[] args){
        ...
        System.out.println(G.getCC(6)); 
        System.out.println(G.getCC(7)); 
        System.out.println(G.getCC(10)); 
        System.out.println(G.getCC(22)); 
        System.out.println(G.getCC(-4)); 
    }
}